    ...
    return (
        ...
        >
            {({
                ...
                <Container component={Form} onSubmit={handleSubmit} sx={{ textAlign: "center" }} >
                    <FormField name="Full Name" type="text" />
                    ...
                    <Typography to="/?Dialog=Login" component={Link}
                        sx={{ marginTop: "10px", textDecoration: "none" }}>Already Registered? Login</Typography>
                </Container>
            )}
        </Formik>
    );
